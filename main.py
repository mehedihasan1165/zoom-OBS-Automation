...
def obs_recording_start():
    ...
    time.sleep(15)
    x, y = pyautogui.locateCenterOnScreen('images\\startRecording.png')
    time.sleep(2)
    pyautogui.click(x, y)
    time.sleep(2)
...
def obs_recording_stop():
    ...
    pyautogui.write('obs')
    pyautogui.press('enter', interval=1.5)
    x, y = pyautogui.locateCenterOnScreen('images\\stopRecording.png')
    time.sleep(2)
    pyautogui.click(x, y)
    time.sleep(5)
...
def zoom():
    ...
    pyautogui.press('enter', interval=1.5)
    time.sleep(15)
    x, y = pyautogui.locateCenterOnScreen('images\\join.png')
    time.sleep(2)
    pyautogui.click(x, y)
...
print('\nScheduling meeting every day at ', meet_time)
